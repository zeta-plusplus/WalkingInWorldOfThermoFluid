...
model HeatingClosedVolume_temp02
  ...
  Modelica.Fluid.Machines.SweptVolume sweptVolume1(redeclare package Medium = Modelica.Media.Water.StandardWaterOnePhase, clearance = 0.001, pistonCrossArea = 0.01, use_HeatTransfer = true, use_portsData = false)  annotation(
