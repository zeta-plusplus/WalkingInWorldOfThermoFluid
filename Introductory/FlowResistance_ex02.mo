...
model FlowResistance_ex02
  ...
  Modelica.Fluid.Sources.MassFlowSource_T boundary(redeclare package Medium = Modelica.Media.Air.DryAirNasa, T = 15 + 273.15, m_flow = 1, nPorts = 1, use_m_flow_in = true) annotation(
  ...
  Modelica.Fluid.Vessels.ClosedVolume volume1(redeclare package Medium = Modelica.Media.Air.DryAirNasa, V = 1.0e-3, nPorts = 2, use_portsData = false) annotation(
