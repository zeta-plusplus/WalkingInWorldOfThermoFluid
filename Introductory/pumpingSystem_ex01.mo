...
equation
  ...
  connect(volumeFlowRate1.V_flow, d_flowPwr.u1) annotation(
    Line(points = {{-10, -2}, {-10, -2}, {-10, -30}, {-24, -30}, {-24, -38}, {-24, -38}}, color = {0, 0, 127}));
  connect(relativePressure1.p_rel, d_flowPwr.u2) annotation(
    Line(points = {{-40, -30}, {-40, -30}, {-40, -32}, {-36, -32}, {-36, -38}, {-36, -38}}, color = {0, 0, 127}));
  connect(pump.port_a, relativePressure1.port_b) annotation(
    Line(points = {{-50, 10}, {-58, 10}, {-58, -20}, {-50, -20}}, color = {0, 127, 255}));
  connect(pump.port_b, relativePressure1.port_a) annotation(
    Line(points = {{-30, 10}, {-26, 10}, {-26, -20}, {-30, -20}}, color = {0, 127, 255}));
  ...
  connect(pump.port_b, volumeFlowRate1.port_a) annotation(
    Line(points = {{-30, 10}, {-20, 10}, {-20, 10}, {-20, 10}}, color = {0, 127, 255}));
  connect(pipe.port_b, boundary1.ports[1]) annotation(
    Line(points = {{60, 10}, {70, 10}}, color = {0, 127, 255}));
  connect(ramp1.y, pump.N_in) annotation(
    Line(points = {{-59, 60}, {-40, 60}, {-40, 20}}, color = {0, 0, 127}));
  connect(boundary.ports[1], pump.port_a) annotation(
    Line(points = {{-70, 10}, {-50, 10}, {-50, 10}, {-50, 10}}, color = {0, 127, 255}));
  annotation(
