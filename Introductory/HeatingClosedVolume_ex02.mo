...
model HeatingClosedVolume_ex02
  ...
  Modelica.Fluid.Vessels.ClosedVolume volume(redeclare package Medium = Modelica.Media.Air.DryAirNasa, V = 0.001, nPorts = 0, use_HeatTransfer = true, use_portsData = false) annotation(
