...
model HeatingClosedVolume_ex01
  ...
  Modelica.Fluid.Vessels.ClosedVolume volume(redeclare package Medium = Modelica.Media.Water.StandardWaterOnePhase, V = 0.001, nPorts = 0, use_HeatTransfer = true, use_portsData = false) annotation(
