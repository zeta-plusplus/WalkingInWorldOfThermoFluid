...
model ExpansionValve_R134_001
  ...
  Modelica.Fluid.Sources.Boundary_pT boundary_R134(redeclare package Medium = Modelica.Media.R134a.R134a_ph, T = 26 + 273.15,nPorts = 1, p = 3 * 100 * 1000, use_p_in = true)  annotation(
  ...
  Modelica.Fluid.Sources.Boundary_pT boundary_air(redeclare package Medium= Modelica.Media.Air.DryAirNasa, T = 26 + 273.15, nPorts = 1, p = 3 * 100 * 1000, use_p_in = true) annotation(
