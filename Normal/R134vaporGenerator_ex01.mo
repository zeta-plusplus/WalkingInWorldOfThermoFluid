...
model R134vaporGenerator_ex01 "Complete drum boiler model, including evaporator and supplementary components"
  extends Modelica.Icons.Example;
  parameter Boolean use_inputs = false "use external inputs instead of test data contained internally";
  Modelica.Fluid.Examples.DrumBoiler.BaseClasses.EquilibriumDrumBoiler evaporator(redeclare package Medium = Modelica.Media.R134a.R134a_ph, V_l(fixed = true), V_l_start = 0.49, V_t = 1, cp_D = 500, m_D = 1e-9, p(fixed = false, start = 101.325 * 1000), p_start = 1 * 101.325 * 1000) annotation(
  ...
  Modelica.Fluid.Sensors.Temperature temperatureSteam(redeclare package Medium = Modelica.Media.R134a.R134a_ph) annotation(
    Placement(transformation(origin = {-3, -1}, extent = {{10, 10}, {-10, -10}}, rotation = 180)));
  Modelica.Fluid.Sensors.Pressure pressure(redeclare package Medium = Modelica.Media.R134a.R134a_ph) annotation(
  ...
  Modelica.Fluid.Sensors.Temperature temperatureWater(redeclare package Medium = Modelica.Media.R134a.R134a_ph) annotation(
    Placement(visible = true, transformation(origin = {-85, -3}, extent = {{10, 10}, {-10, -10}}, rotation = 180)));
  Modelica.Fluid.Sensors.MassFlowRate massFlowRate(redeclare package Medium = Modelica.Media.R134a.R134a_ph) annotation(
...
equation
  ...
  connect(pressure.port, massFlowVapor.port_a) annotation(
  ...
  connect(temperatureSteam.port, massFlowVapor.port_a) annotation(
