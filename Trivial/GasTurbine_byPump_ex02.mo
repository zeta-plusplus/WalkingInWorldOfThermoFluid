...
model GasTurbine_byPump_ex02
  ...
  Modelica.Blocks.Sources.Ramp ramp_N(duration = 10, height = 1000, offset = 1000, startTime = 10) annotation(
  ...
  Modelica.Fluid.Valves.ValveLinear valveLinear1(redeclare package Medium = Modelica.Media.Air.DryAirNasa, dp_nominal(displayUnit = "Pa") = 100 * 1000, m_flow_nominal = 2)  annotation(
    Placement(visible = true, transformation(origin = {80, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.Ramp ramp_valve(duration = 10, height = -0.5, offset = 1, startTime = 30) annotation(
...
equation
  connect(ramp_valve.y, valveLinear1.opening) annotation(
    Line(points = {{80, -1}, {80, -22}}, color = {0, 0, 127}));
  ...
  annotation(
    ...
    Diagram(coordinateSystem(extent = {{-160, -80}, {140, 100}}, initialScale = 0.1), graphics = {Line(origin = {-52.02, 41.02}, points = {{9.0238, -15.0238}, {7.0238, 12.9762}, {-8.9762, 14.9762}}, arrow = {Arrow.None, Arrow.Open}), Text(origin = {-156, 41}, extent = {{64, -1}, {112, -7}}, textString = "mechanical power"), Text(origin = {-134, -47}, extent = {{64, -1}, {144, -13}}, textString = "gas turbine by 'pump' component")}),
    __OpenModelica_commandLineOptions = "");
end GasTurbine_byPump_ex02;
