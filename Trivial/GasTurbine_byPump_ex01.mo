...
equation
  ...
  annotation(
    ...
    Diagram(coordinateSystem(extent = {{-160, -80}, {140, 100}}, initialScale = 0.1), graphics = {Line(origin = {-52.02, 41.02}, points = {{9.0238, -15.0238}, {7.0238, 12.9762}, {-8.9762, 14.9762}}, arrow = {Arrow.None, Arrow.Open}), Text(origin = {-156, 41}, extent = {{64, -1}, {112, -7}}, textString = "mechanical power"), Text(origin = {-132, -47}, extent = {{64, -1}, {148, -15}}, textString = "gas turbine by 'pump' component")}),
    __OpenModelica_commandLineOptions = "");
end GasTurbine_byPump_ex01;
