...
model PumpAsTurbine_ex03
  ...
  Modelica.Blocks.Sources.Ramp ramp_p_in(duration = 10, height = 2 * 101.325 * 1000, offset = 5 * 101.325 * 1000, startTime = 30) annotation(
