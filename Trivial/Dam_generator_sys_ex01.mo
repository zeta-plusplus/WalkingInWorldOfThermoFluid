...
equation
  ...
  connect(dam.ports[2], pressure1.port) annotation(
    Line(points = {{-140, -20}, {-134, -20}, {-134, -30}, {-90, -30}}, color = {0, 127, 255}));
  ...
  annotation(
    ...
    Diagram(coordinateSystem(extent = {{-180, -120}, {140, 120}}), graphics = {Line(origin = {-64.5071, 50.002}, points = {{9.0238, -15.0238}, {7.0238, 12.9762}, {-8.9762, 14.9762}}, arrow = {Arrow.None, Arrow.Open}), Text(origin = {-166, 57}, extent = {{64, -1}, {112, -7}}, textString = "mechanical power"), Text(origin = {-140, -45}, extent = {{64, -1}, {148, -15}}, textString = "hydro turbine by 'pump' component"), Text(origin = {-214, -97}, extent = {{64, -1}, {166, -15}}, textString = "just prevent tank from getting empty"), Text(origin = {-246, 63}, extent = {{68, -13}, {126, -25}}, textString = "port at bottom of tank"), Text(origin = {-214, 55}, extent = {{34, -15}, {126, -25}}, textString = "has pressure due to height of fluid")}),
