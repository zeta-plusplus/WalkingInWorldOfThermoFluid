...
model TurboJetEngine_byPump_1spool_ex01
  ...
  //----------
  inner Modelica.Fluid.System system(energyDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, massDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, momentumDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial)  annotation(
  ...
  Modelica.Fluid.Sensors.Pressure p090(redeclare package Medium = Modelica.Media.Air.DryAirNasa) annotation(
  ...
  Modelica.Fluid.Vessels.ClosedVolume Comb030(redeclare package Medium = Modelica.Media.Air.DryAirNasa, V = 0.01, energyDynamics = Modelica.Fluid.Types.Dynamics.SteadyState, massDynamics = Modelica.Fluid.Types.Dynamics.SteadyState, nPorts = 2, use_HeatTransfer = true, use_portsData = false)  annotation(
  ...
  Modelica.Blocks.Sources.Ramp ramp_heat(duration = 2, height = 2000 * 1000, offset = 2000 * 1000, startTime = 10) annotation(
    Placement(visible = true, transformation(origin = {-130, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Mechanics.Rotational.Components.Inertia inertia(J = 1, w(fixed = true, start = 500 * 2 * Modelica.Constants.pi / 60))  annotation(
  ...
  Modelica.Fluid.Sensors.Temperature T4(redeclare package Medium = Modelica.Media.Air.DryAirNasa) annotation(
    Placement(visible = true, transformation(origin = {-55, -35}, extent = {{-5, -5}, {5, 5}}, rotation = 180)));
  ...
  Modelica.Fluid.Sensors.Temperature T090(redeclare package Medium = Modelica.Media.Air.DryAirNasa) annotation(
  ...
  Modelica.Fluid.Valves.ValveCompressible Noz070(redeclare package Medium = Modelica.Media.Air.DryAirNasa, dp_nominal = 6 * 100 * 1000, m_flow_nominal = 3, p_nominal = 6 * 100 * 1000)  annotation(
    Placement(visible = true, transformation(origin = {120, -30}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Modelica.Blocks.Sources.Ramp ramp_open_Noz070(duration = 2, height = 0.1, offset = 0.9, startTime = 15) annotation(
    Placement(visible = true, transformation(origin = {120, 10}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Modelica.Fluid.Sensors.MassFlowRate massFlow070(redeclare package Medium = Modelica.Media.Air.DryAirNasa) annotation(
    Placement(visible = true, transformation(origin = {79, -30}, extent = {{-5, 5}, {5, -5}}, rotation = 0)));
  Modelica.Blocks.Sources.RealExpression calcVel090(y = Noz070.V_flow / (Noz070.Av * Noz070.opening))  annotation(
    Placement(visible = true, transformation(origin = {101, -71}, extent = {{-17, -9}, {17, 9}}, rotation = 0)));
  Modelica.Blocks.Interaction.Show.RealValue real_Vel090(significantDigits = 6) annotation(
    Placement(visible = true, transformation(origin = {149, -71}, extent = {{-15, -9}, {15, 9}}, rotation = 0)));
  Modelica.Blocks.Math.Product Fg070 annotation(
    Placement(visible = true, transformation(origin = {146, -90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Interaction.Show.RealValue real_Fg070(significantDigits = 6) annotation(
    Placement(visible = true, transformation(origin = {183, -90}, extent = {{-15, -9}, {15, 9}}, rotation = 0)));
  Modelica.Mechanics.Rotational.Sensors.SpeedSensor NmechSh annotation(
  ...
  Modelica.Blocks.Interaction.Show.RealValue real_NmechSh(significantDigits = 6) annotation(
    Placement(visible = true, transformation(origin = {-123, -130}, extent = {{17, -10}, {-17, 10}}, rotation = 0)));
  ...
  Modelica.Blocks.Interaction.Show.RealValue real_pwrTrb041(significantDigits = 6) annotation(
    Placement(visible = true, transformation(origin = {-23, -114}, extent = {{-17, -10}, {17, 10}}, rotation = 0)));
equation
  ...
  connect(Cmp.port_b, p3.port) annotation(
    Line(points = {{-140, -30}, {-127, -30}}, color = {0, 127, 255}, thickness = 1));
  connect(p1.port, boundary.ports[1]) annotation(
    Line(points = {{-232, -30}, {-240, -30}}, color = {0, 127, 255}, thickness = 1));
  connect(p1.port, massFlowRate.port_a) annotation(
    Line(points = {{-232, -30}, {-210, -30}}, color = {0, 127, 255}, thickness = 1));
  connect(massFlowRate.port_b, Cmp.port_a) annotation(
    Line(points = {{-200, -30}, {-180, -30}}, color = {0, 127, 255}, thickness = 1));
  connect(Cmp.shaft, pwrCmp.flange_b) annotation(
    Line(points = {{-160, -50}, {-160, -90}, {-140, -90}}, thickness = 1));
  connect(prescribedHeatFlow.port, Comb030.heatPort) annotation(
    Line(points = {{-90, 30}, {-90, -15}}, color = {191, 0, 0}, thickness = 1));
  connect(ramp_heat.y, prescribedHeatFlow.Q_flow) annotation(
    Line(points = {{-119, 30}, {-111, 30}}, color = {0, 0, 127}));
  connect(pwrCmp.flange_a, inertia.flange_a) annotation(
    Line(points = {{-120, -90}, {-100, -90}}, thickness = 1));
  ...
  connect(p3.port, T3.port) annotation(
    Line(points = {{-127, -30}, {-100, -30}}, color = {0, 127, 255}, thickness = 1));
  connect(Comb030.ports[1], T3.port) annotation(
    Line(points = {{-75, -30}, {-100, -30}}, color = {0, 127, 255}, thickness = 1));
  ...
  connect(Comb030.ports[2], T4.port) annotation(
    Line(points = {{-75, -30}, {-55, -30}}, color = {0, 127, 255}, thickness = 1));
  connect(trb041.port_b, T4.port) annotation(
    Line(points = {{-40, -30}, {-55, -30}}, color = {0, 127, 255}, thickness = 1));
  connect(T4.T, realValue111.numberPort) annotation(
    Line(points = {{-58.5, -35}, {-68, -35}, {-68, -61}, {-64, -61}}, color = {0, 0, 127}));
  connect(p090.p, realValue4.numberPort) annotation(
    Line(points = {{190.5, -25}, {193, -25}, {193, -40}, {189, -40}}, color = {0, 0, 127}));
  connect(p090.port, T090.port) annotation(
    Line(points = {{185, -30}, {209, -30}}, color = {0, 127, 255}, thickness = 1));
  connect(T090.T, realValue13.numberPort) annotation(
    Line(points = {{206.5, -35}, {200, -35}, {200, -54}}, color = {0, 0, 127}));
  connect(boundary1.ports[1], T090.port) annotation(
    Line(points = {{240, -30}, {210, -30}}, color = {0, 127, 255}, thickness = 1));
  connect(trb041.port_a, p45.port) annotation(
    Line(points = {{0, -30}, {33, -30}}, color = {0, 127, 255}, thickness = 1));
  connect(p45.port, T45.port) annotation(
    Line(points = {{33, -30}, {58, -30}}, color = {0, 127, 255}, thickness = 1));
  ...
  connect(Noz070.port_b, p090.port) annotation(
    Line(points = {{140, -30}, {186, -30}}, color = {0, 127, 255}, thickness = 1));
  connect(ramp_open_Noz070.y, Noz070.opening) annotation(
    Line(points = {{120, -1}, {120, -14}}, color = {0, 0, 127}));
  connect(Noz070.port_a, massFlow070.port_b) annotation(
    Line(points = {{100, -30}, {84, -30}}, color = {0, 127, 255}, thickness = 1));
  connect(massFlow070.port_a, T45.port) annotation(
    Line(points = {{74, -30}, {58, -30}}, color = {0, 127, 255}, thickness = 1));
  connect(calcVel090.y, real_Vel090.numberPort) annotation(
    Line(points = {{119.7, -71}, {132, -71}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
  connect(calcVel090.y, Fg070.u1) annotation(
    Line(points = {{119.7, -71}, {123.7, -71}, {123.7, -84}, {133.7, -84}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
  connect(massFlow070.m_flow, Fg070.u2) annotation(
    Line(points = {{79, -35.5}, {79, -96}, {134, -96}}, color = {0, 0, 127}, pattern = LinePattern.Dash));
  connect(Fg070.y, real_Fg070.numberPort) annotation(
    Line(points = {{157, -90}, {165, -90}}, color = {0, 0, 127}));
  connect(inertia.flange_b, NmechSh.flange) annotation(
    Line(points = {{-80, -90}, {-64, -90}}));
  connect(to_rpm.u, NmechSh.w) annotation(
    Line(points = {{-70, -130}, {-64, -130}, {-64, -110}}, color = {0, 0, 127}));
  connect(to_rpm.y, real_NmechSh.numberPort) annotation(
    Line(points = {{-93, -130}, {-104, -130}}, color = {0, 0, 127}));
  connect(inertia.flange_b, pwrTrb.flange_b) annotation(
    Line(points = {{-80, -90}, {-40, -90}}, thickness = 1));
  connect(pwrTrb.flange_a, trb041.shaft) annotation(
    Line(points = {{-20, -90}, {-20, -50}}, thickness = 1));
  connect(pwrTrb.power, real_pwrTrb041.numberPort) annotation(
    Line(points = {{-22, -101}, {-22, -106.5}, {-43, -106.5}, {-43, -114}}, color = {0, 0, 127}));
  annotation(
