...
model HydroTurbine_byPump_ex02
  ...
  Modelica.Blocks.Sources.Ramp ramp_N(duration = 10, height = 100, offset = 1000, startTime = 50) annotation(
  ...
  Modelica.Blocks.Sources.Ramp ramp_T_in(duration = 10, height = 50, offset = 288.15, startTime = 30) annotation(
