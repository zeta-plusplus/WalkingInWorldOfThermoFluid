...
model GasTurbineEngine_byPump_1spool_ex01
  ...
  Modelica.Blocks.Math.UnitConversions.From_rpm from_rpm1 annotation(
    Placement(visible = true, transformation(origin = {158, -90}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  ...
  Modelica.Mechanics.Rotational.Sensors.PowerSensor pwrGen annotation(
    Placement(visible = true, transformation(origin = {98, -90}, extent = {{10, 10}, {-10, -10}}, rotation = 180)));
  ...
  Modelica.Blocks.Interaction.Show.RealValue realValue1(significantDigits = 6) annotation(
    Placement(visible = true, transformation(origin = {116, -116}, extent = {{-16, -10}, {16, 10}}, rotation = 0)));
  ...
  Modelica.Fluid.Valves.ValveCompressible valve(redeclare package Medium = Modelica.Media.Air.DryAirNasa,dp_nominal = 10 * 1000, m_flow_nominal = 2)  annotation(
    Placement(visible = true, transformation(origin = {100, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.Ramp ramp_valve(duration = 5, height = 0, offset = 1, startTime = 10) annotation(
...
equation
  ...
  connect(from_rpm1.y, speed1.w_ref) annotation(
    Line(points = {{147, -90}, {139, -90}}, color = {0, 0, 127}));
  connect(ramp_N.y, from_rpm1.u) annotation(
    Line(points = {{179, -90}, {169, -90}}, color = {0, 0, 127}));
  connect(Trb.shaft, pwrGen.flange_a) annotation(
    Line(points = {{54, -50}, {54, -90}, {88, -90}}));
  connect(pwrGen.flange_b, speed1.flange) annotation(
    Line(points = {{108, -90}, {118, -90}}));
  ...
  connect(pwrGen.power, realValue1.numberPort) annotation(
    Line(points = {{90, -101}, {90, -116}, {98, -116}}, color = {0, 0, 127}));
  ...
  connect(Trb.port_a, valve.port_a) annotation(
    Line(points = {{74, -30}, {90, -30}}, color = {0, 127, 255}));
  connect(valve.port_b, p5.port) annotation(
    Line(points = {{110, -30}, {152, -30}}, color = {0, 127, 255}));
  ...
  connect(ramp_valve.y, valve.opening) annotation(
    Line(points = {{100, 9}, {100, -23}}, color = {0, 0, 127}));
  connect(T4.port, Trb.port_b) annotation(
    Line(points = {{-58, -30}, {34, -30}}, color = {0, 127, 255}));
  annotation(
