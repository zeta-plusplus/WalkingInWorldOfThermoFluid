...
model HydroTurbine_byPump_ex01
  ...
  Modelica.Blocks.Sources.Ramp ramp_p_in(duration = 10, height = 5 * 101.325 * 1000, offset = 10 * 101.325 * 1000, startTime = 10) annotation(
...
equation
  ...
  annotation(
    ...
    Diagram(coordinateSystem(extent = {{-160, -80}, {140, 100}}, initialScale = 0.1), graphics = {Line(origin = {-52.02, 41.02}, points = {{9.0238, -15.0238}, {7.0238, 12.9762}, {-8.9762, 14.9762}}, arrow = {Arrow.None, Arrow.Open}), Text(origin = {-156, 41}, extent = {{64, -1}, {112, -7}}, textString = "mechanical power"), Text(origin = {-132, -47}, extent = {{64, -1}, {152, -15}}, textString = "hydro turbine by 'pump' component")}),
