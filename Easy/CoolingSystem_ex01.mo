...
model CoolingSystem_ex01
  ...
  Modelica.Fluid.Sources.MassFlowSource_T boundary2(redeclare package Medium = Modelica.Media.Incompressible.Examples.Glycol47, T = 15 + 273.15, m_flow = 5, nPorts = 1) annotation(
