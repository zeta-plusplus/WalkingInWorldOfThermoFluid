...
model AdiabaticExpansion_ex01
  ...
  Modelica.Fluid.Vessels.ClosedVolume volume(nPorts = 5, redeclare package Medium = fluid1, use_portsData = false, V = 0.001) annotation(
    Placement(transformation(origin = {-120, -18}, extent = {{-10, 10}, {10, -10}})));
  Modelica.Fluid.Vessels.ClosedVolume volume1(redeclare package Medium = fluid1, V = 0.001, nPorts = 5, use_portsData = false) annotation(
...
equation
  ...
  connect(specificEnthalpy1.port, volume1.ports[1]) annotation(
    Line(points = {{140, 4}, {140, -7.75}, {110, -7.75}, {110, -8}}, color = {0, 127, 255}));
  ...
  connect(specificEntropy1.port_b, volume1.ports[2]) annotation(
    Line(points = {{95, -8}, {110, -8}}, color = {0, 127, 255}));
  ...
  connect(volume.ports[2], specificEntropy11.port_a) annotation(
  ...
  connect(pipe.port_b, volume.ports[3]) annotation(
    Line(points = {{-168, -8}, {-120, -8}}, color = {0, 127, 255}));
  connect(pipe1.port_a, volume1.ports[3]) annotation(
    Line(points = {{168, -8}, {110, -8}}, color = {0, 127, 255}));
  connect(pipe1.port_b, boundary3.ports[1]) annotation(
    Line(points = {{188, -8}, {198, -8}}, color = {0, 127, 255}));
  connect(volume.ports[4], temperature.port) annotation(
    Line(points = {{-120, -8}, {-108, -8}, {-108, -34}}, color = {0, 127, 255}));
  ...
  connect(volume1.ports[4], temperature1.port) annotation(
    Line(points = {{110, -8}, {126, -8}, {126, -34}}, color = {0, 127, 255}));
  connect(volume.ports[5], pressure.port) annotation(
    Line(points = {{-120, -8}, {-102, -8}, {-102, -56}}, color = {0, 127, 255}));
  ...
  connect(pressure1.port, volume1.ports[5]) annotation(
    Line(points = {{134, -52}, {134, -8}, {110, -8}}, color = {0, 127, 255}));
  annotation(
