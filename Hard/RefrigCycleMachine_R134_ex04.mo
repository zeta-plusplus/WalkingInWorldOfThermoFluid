...
model RefrigCycleMachine_R134_ex04
  ...
  Modelica.Thermal.HeatTransfer.Sensors.HeatFlowSensor Q_flow_HX020 annotation(
    Placement(transformation(origin = {149, 344}, extent = {{-4, -4}, {4, 4}}, rotation = 180)));
  Modelica.Blocks.Math.Gain gain1(k = 1/1000) annotation(
    Placement(transformation(origin = {157, 371}, extent = {{-3, -3}, {3, 3}})));
  Modelica.Blocks.Interaction.Show.RealValue realValue_Q_flow_HX020(significantDigits = sigDigits_Q_flow) annotation(
    Placement(transformation(origin = {178, 371}, extent = {{-11, -7}, {11, 7}})));
...
//
  ...
  connect(gain1.y, realValue_Q_flow_HX020.numberPort) annotation(
    Line(points = {{160.3, 371}, {165.6, 371}}, color = {0, 0, 127}));
  connect(T_hot.port, Q_flow_HX020.port_b) annotation(
    Line(points = {{136, 344}, {145, 344}}, color = {191, 0, 0}, thickness = 2));
  connect(Q_flow_HX020.port_a, conv_HX020.fluid) annotation(
    Line(points = {{153, 344}, {160, 344}}, color = {191, 0, 0}, thickness = 2));
  ...
  connect(gain1.u, Q_flow_HX020.Q_flow) annotation(
    Line(points = {{153.4, 371}, {149, 371}, {149, 348}}, color = {0, 0, 127}));
  ...
  connect(realExpression.y, curve_Ts_HX020.u_sUpper) annotation(
    Line(points = {{38.7, 106}, {42.7, 106}}, color = {0, 0, 127}));
  connect(realExpression1.y, curve_Ts_HX020.u_sLower) annotation(
    Line(points = {{20.7, 102}, {42.4, 102}}, color = {0, 0, 127}));
  ...
  annotation(
    ...
    Diagram(coordinateSystem(extent = {{0, 380}, {400, 0}}), graphics = {Text(origin = {95, 164}, extent = {{-5, 2}, {5, -2}}, textString = "[degC]", horizontalAlignment = TextAlignment.Left), Text(origin = {93, 243}, extent = {{-5, 2}, {5, -2}}, textString = "[degC]", horizontalAlignment = TextAlignment.Left), Text(origin = {142, 178}, extent = {{-5, 2}, {5, -2}}, textString = "[kg/m3]", horizontalAlignment = TextAlignment.Left), Text(origin = {142, 233}, extent = {{-5, 2}, {5, -2}}, textString = "[kg/m3]", horizontalAlignment = TextAlignment.Left), Text(origin = {343, 319}, extent = {{-5, 2}, {5, -2}}, textString = "[kg/s]", horizontalAlignment = TextAlignment.Left), Text(origin = {188, 365}, extent = {{-4, 2}, {4, -2}}, textString = "[kW]", horizontalAlignment = TextAlignment.Left), Text(origin = {193, 281}, extent = {{-5, 2}, {5, -2}}, textString = "[degC]", horizontalAlignment = TextAlignment.Left), Text(origin = {209, 267}, extent = {{-5, 2}, {5, -2}}, textString = "[kPa]", horizontalAlignment = TextAlignment.Left), Text(origin = {243, 103}, extent = {{-5, 2}, {5, -2}}, textString = "[degC]", horizontalAlignment = TextAlignment.Left), Text(origin = {185, 141}, extent = {{-5, 2}, {5, -2}}, textString = "[kPa]", horizontalAlignment = TextAlignment.Left), Text(origin = {204, 156}, extent = {{-5, 2}, {5, -2}}, textString = "[kg/m3]", horizontalAlignment = TextAlignment.Left), Text(origin = {164, 91}, extent = {{-4, 2}, {4, -2}}, textString = "[kW]", horizontalAlignment = TextAlignment.Left), Text(origin = {332, 200}, extent = {{-5, 2}, {5, -2}}, textString = "[kg/m3]", horizontalAlignment = TextAlignment.Left), Text(origin = {385, 210}, extent = {{-5, 2}, {5, -2}}, textString = "[degC]", horizontalAlignment = TextAlignment.Left), Text(origin = {385, 284}, extent = {{-5, 2}, {5, -2}}, textString = "[degC]", horizontalAlignment = TextAlignment.Left)}),
    version = "",
